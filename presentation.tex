...
\begin{itemize}
    ...
    \item \textbf{innovative} -- it is constantly evolving and improving (EIPs)
    \item \textbf{TODO: scalable} -- it can handle a large number of transactions (via ZK/sharding)
\end{itemize}
\bigskip
