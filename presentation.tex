...
\begin{itemize}
    ...
    \item Exploit incorrect rounding in online exchanges to get better prices
...
Tools in Ethereum:
\begin{itemize}
    \item \textbf{Echidna}: Coverage-guided fuzzer for Ethereum smart contracts, via hevm
    \item \textbf{Forge}: Built-in fauzzer as part of Foundry, only recently coverage-guided, via reth
    \item \textbf{Medusa}: Fuzzer for Ethereum smart contracts based on geth
\end{itemize}
\end{frame}
